...
(function (root, factory) {
  ...
  // AB Download Manager local REST API (https://github.com/amir1376/ab-download-manager).
  ...
  return {
    MAX_PER_TAB, ABDM_ADD_URL, MEDIA_EXTS, MEDIA_TYPES, SKIP_PATTERNS, LABEL_BY_EXT, PRIORITY,
    realExt, isMediaUrl, labelUrl, outExt, shq, buildCommand, shortUrl, sortMedia, exportContent,
    abdmHeaders, abdmPayload
  };
});
